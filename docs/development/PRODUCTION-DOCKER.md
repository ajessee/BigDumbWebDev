...
- `docker scout cves`: 0 Critical, 5 High as of this date (down from an initial 27 findings, 5 Critical) — see SECURITY-ACCEPTANCE.md for the full remediation and the 5 remaining, tracked findings.
