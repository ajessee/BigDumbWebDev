...
class UsersController < ApplicationController
  before_action :logged_in_user, only: %i[show edit update remove_image remove_resume]
  before_action :correct_user, only: %i[show edit update remove_image remove_resume]
