...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "big_dumb_web_dev_production"
  ...
  # Always log to STDOUT in production (Heroku's logging pipeline expects this;
  # there's no deployment target here where file-based logging would make sense).
