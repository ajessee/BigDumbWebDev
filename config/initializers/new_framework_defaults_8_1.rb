...
#
# This is the real template Rails 8.1.3.1 ships for this file (copied from the installed
# gem, not hand-written), kept as the definitive reference for what config.load_defaults 8.1
# already changed. Everything below is commented out, meaning every one of these new 8.1
# behaviors is already accepted as-is (verified against the full suite - see
# docs/development/UPGRADE-PLAN.md's version-climb notes) - none needed to be pinned back
# to their pre-8.1 behavior. Uncomment a line only to deliberately opt OUT of that default.
#
